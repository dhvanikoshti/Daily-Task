            ...
            <>
                <div className=''>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10 m-10'>
                        {tv.map((item,index) => <div className='border-2  border-gray-300 text-center p-2'>
                            ...
                            <div>
                                <div><button className='bg-gray-800 px-5 py-3 text-amber-50 rounded-3xl' onClick={()=>clickHere(item.title)}>ADD TO CART</button>
                                    <button className='m-2 py-1 px-3 border-2 border-gray-300' onClick={decrement} type='button'>-</button>
                                    <span className=''>{count}</span>
                                    <button className='m-2 py-1 px-3 border-2 border-gray-300' onClick={()=>increment(item.id)} type='button'>+</button>
                                </div>
                            </div>
                        </div>)}
                    </div>
