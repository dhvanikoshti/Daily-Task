...
function Task2(){
    return(
        <>
        <div className='m-20 border-2  bg-amber-50 shadow-md border-gray-400 p-10 min-h'>
           <div className='font-bold text-xs md:text-2xl sm:text-xl lg:text-4xl text-center font-serif text-amber-950'>Image Gallary</div> 
